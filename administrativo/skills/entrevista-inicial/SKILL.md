...
- **No confundir recurso de reconsideración con apelación.** La reconsideración se interpone ante el mismo funcionario que dictó el acto; la apelación, ante su superior jerárquico. La resolución de la apelación (o la inexistencia de superior) es lo que agota la vía gubernativa [verificar]. Un error aquí tiene consecuencias de inadmisibilidad.
- **No dar por hecho que el silencio es positivo.** En Panamá la regla general es el silencio administrativo NEGATIVO: transcurrido el plazo sin decisión, la petición o recurso se entiende denegado, salvo norma especial en contrario [verificar]. Verificar siempre la norma sectorial aplicable.
- **No ignorar los plazos del contencioso.** La demanda de plena jurisdicción ante la Sala Tercera está sujeta a un plazo de caducidad (referido frecuentemente como 2 meses desde la notificación o ejecutoria del acto) [verificar]; la demanda de nulidad puede presentarse en cualquier tiempo [verificar]. Confirmar siempre el plazo exacto en el Código Judicial.
- **No olvidar el agotamiento de la vía gubernativa.** Es presupuesto para acudir a la Sala Tercera, salvo en las acciones de nulidad y demás excepciones legales [verificar].
